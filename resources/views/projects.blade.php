...
<section id="projects" class="content-section space-y-12">
        ...
        <form action="{{ route('projects.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    <label for="tech_stack" class="block mb-2 text-sm font-medium text-secondary">Tech Stack (pisahkan dengan koma)</label>
                    <input type="text" id="tech_stack" name="tech_stack" value="{{ old('tech_stack') }}" class="form-input w-full px-4 py-2.5 rounded-lg text-base focus:ring-2 focus:border-transparent transition" placeholder="e.g., Laravel, MySQL, Tailwind CSS">
                </div>
                <div class="md:col-span-2">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}" class="card rounded-2xl overflow-hidden group hover:-translate-y-1.5 transition-transform duration-300">
            <div class="overflow-hidden"><img src="{{ asset('storage/' . $project->image) }}" alt="{{ $project->title }}" class="w-full h-56 object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out"></div>
            <div class="p-6">
