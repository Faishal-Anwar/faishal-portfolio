...
<head>
    ...
    <meta property="og:image" content="{{ Vite::asset('resources/img/profile.png') }}">
    ...
    <meta property="twitter:image" content="{{ Vite::asset('resources/img/profile.png') }}">
    ...
    <div class="flex min-h-screen">
        ...
        <aside data-aos="fade-right" data-aos-duration="1000" class="sidebar hidden lg:flex w-64 flex-col p-6 shadow-xl rounded-3xl fixed top-8 bottom-8 left-8">
            <div class="flex items-center gap-4 mb-6">
                <img src="{{ Vite::asset('resources/img/profile.png') }}" alt="Profile Photo" class="w-12 h-12 rounded-full object-cover profile-logo">
                <div>
            ...
            <div class="container mx-auto px-4">
                <div class="flex justify-between items-center h-16">
                    <div class="flex items-center gap-3">
                        <img src="{{ Vite::asset('resources/img/profile.png') }}" alt="Profile Photo" class="w-8 h-8 rounded-full object-cover profile-logo">
