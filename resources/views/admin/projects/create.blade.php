...
<div class="max-w-3xl mx-auto space-y-20">
    <section data-aos="fade-up" class="space-y-8 pt-8 text-left">
        ...
        @if ($errors->any())
        <div class="glass-card p-6 border-red-500/20 bg-red-500/5 text-red-500 text-sm font-bold uppercase tracking-widest">
            ...
            <form action="{{ route('admin.projects.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8 text-left">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
                    <div class="space-y-2">
                        ...
                        <input type="text" name="title" value="{{ old('title') }}" required class="form-input @error('title') border-red-500 @enderror" placeholder="e.g. AI Sentiment Analyzer">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="year" value="{{ old('year') }}" required class="form-input @error('year') border-red-500 @enderror" placeholder="e.g. 2024">
                ...
                <div class="space-y-2 text-left">
                    ...
                    <textarea name="description" rows="3" required class="form-input @error('description') border-red-500 @enderror" placeholder="Short summary of the project...">{{ old('description') }}</textarea>
                ...
                <div class="space-y-2 text-left">
                    ...
                    <input type="file" name="image" class="form-input bg-secondary @error('image') border-red-500 @enderror" accept="image/*">
                ...
                <div class="space-y-2 text-left">
                    ...
                    <input type="file" name="gallery[]" multiple class="form-input bg-secondary @error('gallery.*') border-red-500 @enderror" accept="image/*">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
                    <div class="space-y-2">
                        ...
                        <input type="text" name="icon" value="{{ old('icon') }}" required class="form-input @error('icon') border-red-500 @enderror" placeholder="e.g. brain, code, database">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="tags" value="{{ old('tags') }}" required class="form-input @error('tags') border-red-500 @enderror" placeholder="e.g. Python, PyTorch, BERT">
                ...
                <div class="space-y-2 text-left">
                    ...
                    <input type="url" name="github_url" value="{{ old('github_url') }}" class="form-input @error('github_url') border-red-500 @enderror" placeholder="https://github.com/...">
                ...
                <div class="space-y-2 text-left">
                    ...
                    <textarea name="case_study" rows="10" class="form-input @error('case_study') border-red-500 @enderror" placeholder="Detailed case study content...">{{ old('case_study') }}</textarea>
