...
<div class="max-w-5xl mx-auto space-y-20">
    ...
    <div data-aos="zoom-in">
        <section class="glass-card p-12 sm:p-20 text-center space-y-8 elite-grid">
            <h2 class="text-4xl font-bold tracking-tight text-main">Do you have any project idea?</h2>
