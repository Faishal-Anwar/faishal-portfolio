            ...
            <form action="{{ route('contact.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" placeholder="jane@gmail.com" required class="form-input w-full px-4 py-2.5 rounded-lg text-base focus:ring-2 focus:border-transparent transition">
                    </div>
                </div>
                <div class="mt-5">
