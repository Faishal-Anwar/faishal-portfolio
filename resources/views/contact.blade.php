...
<div class="max-w-5xl mx-auto space-y-20">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 text-main">
        ...
        <div data-aos="fade-up" data-aos-delay="0">
            <div id="email-card" class="glass-card p-8 flex justify-between items-center group h-full cursor-pointer overflow-hidden">
                <div class="flex items-center gap-6 min-w-0">
                    <div class="w-12 h-12 bg-zinc-100 dark:bg-zinc-800 rounded-2xl flex items-center justify-center shrink-0">
                        <i id="email-icon" data-lucide="mail" class="w-6 h-6 text-zinc-900 dark:text-zinc-100"></i>
                    </div>
                    <div class="flex flex-col text-left min-w-0">
                        <span id="email-text" class="font-bold text-lg text-main truncate">{{ $profile->email }}</span>
                    </div>
                </div>
                <div class="flex items-center justify-center shrink-0 ml-4">
                    <i data-lucide="copy" class="w-6 h-6 text-muted group-hover:text-zinc-900 dark:group-hover:text-zinc-100 transition-colors"></i>
                </div>
            </div>
        </div>
